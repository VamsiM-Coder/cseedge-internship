...
class Account{
  ...
  public void fund_Transfer(){
    ...
    if(amt_transfer > 0.0 && balance > amt_transfer){
        ...
        System.out.println("Amount "+amt_transfer+" Transferred Sucessfully into "+
        recepient_Name+"[XXXXXXX"+recepient_Acno.substring(9)+"] Account.\n");
    } 
    else{
